...
public class StudyProgrammePackageImpl extends EPackageImpl implements StudyProgrammePackage {
	 ...
	 */
	@Override
	public EAttribute getSemester_CreditConstraint() {
	...
	public void createPackageContents() {
		...
		createEAttribute(semesterEClass, SEMESTER__CREDIT_CONSTRAINT);
	...
	public void initializePackageContents() {
		...
		initEReference(getSemester_CourseGroups(), this.getCourseGroup(), null, "courseGroups", null, 1, 2, Semester.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getSemester_CreditConstraint(), this.getcredits(), "creditConstraint", null, 0, 1, Semester.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCourseGroup_Status(), ecorePackage.getEString(), "status", null, 1, 1, CourseGroup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getDepartment_Course(), this.getCourse(), null, "course", null, 0, -1, Department.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		// Initialize data types
		initEDataType(creditsEDataType, int.class, "credits", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
