 ...
 * @generated
 */
public class ProgrammeItemProvider 
	...
	protected void addCodePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Programme_code_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Programme_code_feature", "_UI_Programme_type"),
				 StudyProgrammePackage.Literals.PROGRAMME__CODE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addDurationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Programme_duration_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Programme_duration_feature", "_UI_Programme_type"),
				 StudyProgrammePackage.Literals.PROGRAMME__DURATION,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StudyProgrammePackage.Literals.PROGRAMME__PROGRAMME_SEMESTER);
			childrenFeatures.add(StudyProgrammePackage.Literals.PROGRAMME__PROGRAMME_SPECIALIZATON);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StudyProgrammePackage.Literals.PROGRAMME__PROGRAMME_SEMESTER,
				 StudyProgrammeFactory.eINSTANCE.createSemester()));

		newChildDescriptors.add
			(createChildParameter
				(StudyProgrammePackage.Literals.PROGRAMME__PROGRAMME_SPECIALIZATON,
