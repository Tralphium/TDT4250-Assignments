...
public class StudyProgrammeValidator extends EObjectValidator {
	 ...
	 * @generated
	 */
	public boolean validatecredits(int credits, DiagnosticChain diagnostics, Map<Object, Object> context) {
	 ...
	 */
	public static final int CREDITS__MIN__VALUE = 30;
	 ...
	 * @generated
	 */
	public boolean validatecredits_Min(int credits, DiagnosticChain diagnostics, Map<Object, Object> context) {
		boolean result = credits >= CREDITS__MIN__VALUE;
		if (!result && diagnostics != null)
			reportMinViolation(StudyProgrammePackage.Literals.CREDITS, credits, CREDITS__MIN__VALUE, true, diagnostics, context);
		return result;
	}
