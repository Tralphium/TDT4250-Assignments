...
/**
 * This is the item provider adapter for a {@link StudyProgramme.Department} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DepartmentItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StudyProgrammePackage.Literals.DEPARTMENT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addCodePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Department_code_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Department_code_feature", "_UI_Department_type"),
				 StudyProgrammePackage.Literals.DEPARTMENT__CODE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StudyProgrammePackage.Literals.DEPARTMENT__PROGRAMMES);
			childrenFeatures.add(StudyProgrammePackage.Literals.DEPARTMENT__COURSE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StudyProgrammePackage.Literals.DEPARTMENT__PROGRAMMES,
				 StudyProgrammeFactory.eINSTANCE.createProgramme()));

		newChildDescriptors.add
			(createChildParameter
				(StudyProgrammePackage.Literals.DEPARTMENT__COURSE,
				 StudyProgrammeFactory.eINSTANCE.createCourse()));
	}
